...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Neu', href: '/contractors/create' },
];
...
<template>
    <Head title="Handwerker hinzufügen" />
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            <h1 class="text-lg font-semibold">Handwerker hinzufügen</h1>

            <form class="max-w-xl space-y-6" @submit.prevent="submit">
                <div class="grid gap-2">
                    <Label for="company_name">Firma</Label>
                    <Input id="company_name" v-model="form.company_name" required autofocus placeholder="z. B. Sanitär Müller GmbH" />
                    <InputError :message="form.errors.company_name" />
                </div>

                <div class="grid gap-2">
                    <Label for="contact_name">Ansprechpartner</Label>
                    <Input id="contact_name" v-model="form.contact_name" placeholder="Vor- und Nachname" />
